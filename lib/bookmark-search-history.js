...
export function recordSearch(query) {
  try {
    ...
    console.warn('[PageWise]', 'bookmark-search-history: recordSearch', e)
    return null
  }
}
...
export function getSearchHistory(limit) {
  try {
    ...
    console.warn('[PageWise]', 'bookmark-search-history: getSearchHistory', e)
    return []
  }
}
...
export function getPopularSearches(limit = 10) {
  try {
    ...
    console.warn('[PageWise]', 'bookmark-search-history: getPopularSearches', e)
    return []
  }
}
...
export function getSuggestions(partial) {
  try {
    ...
    console.warn('[PageWise]', 'bookmark-search-history: getSuggestions', e)
    return []
  }
}
...
export function clearHistory() {
  try {
    ...
    console.warn('[PageWise]', 'bookmark-search-history: clearHistory', e)
  }
}
