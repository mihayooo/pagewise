...
export class AdvancedTagManager {
  ...
  assignColor(tag) {
    try {
      ...
      console.warn('[PageWise] AdvancedTagManager.assignColor error:', e)
  ...
  getColor(tag) {
    try {
      ...
      console.warn('[PageWise] AdvancedTagManager.getColor error:', e)
      return COLOR_PALETTE[0]
    }
  }
  ...
  setParent(child, parent) {
    ...
    } catch (e) { console.warn('[PageWise] AdvancedTagManager.setParent error:', child, '->', parent, e) }
  }
  ...
  getChildren(tag) {
    try {
      ...
      console.warn('[PageWise] AdvancedTagManager.getChildren error:', tag, e)
      return []
    }
  }
  ...
  getAncestors(tag) {
    try {
      ...
      console.warn('[PageWise] AdvancedTagManager.getAncestors error:', tag, e)
      return []
    }
  }
  ...
  getTagStats() {
    try {
      ...
      console.warn('[PageWise] AdvancedTagManager.getTagStats error:', e)
      return { count: {}, top: [], coOccurrence: [] }
    }
  }
  ...
  autoTag(bookmark) {
    try {
      ...
      } catch (e) { console.warn('[PageWise] AdvancedTagManager.autoTag invalid URL:', bookmark?.url, e) }

      return [...tags]
    } catch (e) {
      console.warn('[PageWise] AdvancedTagManager.autoTag error:', e)
      return []
    }
  }
