 ...
 *
 * 子模块:
 *   - bookmark-io-standalone.js — 独立函数 API (exportToHTML/importFromHTML 等)
 */
...
export {
  ...
  importFromJSON,
  validateImportData,
} from './bookmark-io-standalone.js'

// ==================== BookmarkImportExport ====================

/** BookmarkImportExport 类 */
export class BookmarkImportExport {
  ...
  importFromJSON(json) {
    ...
    try {
      ...
      console.warn('[BookmarkIO]', e?.message || e);
      return { bookmarks: [], clusters: [], tags: [], statuses: [] };
    }
