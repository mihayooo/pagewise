...
export class PluginManager {
  ...
  async uninstall(id) {
    ...
    try {
      ...
      console.warn('[Plugin] deleteSkill failed:', id, e)
    }
  }
  ...
  async enable(id) {
    ...
    try {
      ...
      console.warn('[Plugin] toggleSkill failed:', id, e)
    }
  }
  ...
  async disable(id) {
    ...
    try {
      ...
      console.warn('[Plugin] disable toggle failed:', id, e)
    }
  }
  ...
  async exportPlugin(skillId) {
    ...
    try {
      ...
      console.debug('[Plugin] registry unavailable:', e)
    }
  ...
  async exportAll() {
    ...
    for (const skill of skills) {
      try {
        ...
        console.warn('[Plugin] export failed:', skill?.id, e)
      }
    }
    return manifests
  }
