...
export async function saveSession(record) {
  try {
    ...
    console.warn('[PageWise]', 'saveSession error', _e)
  }
}
...
export async function getRecentSessions(limit = 10) {
  try {
    ...
    console.warn('[PageWise]', 'getRecentSessions error', _e)
    return [];
  }
}
...
export async function getWeeklyStats() {
  ...
  try {
    ...
    console.warn('[PageWise]', 'getWeeklyStats error', _e)
    return empty;
  }
}
...
export async function getSessionHistory() {
  try {
    ...
    console.warn('[PageWise]', 'getSessionHistory error', _e)
    return [];
  }
}
