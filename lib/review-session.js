...
export async function saveSession(record) {
  try {
    ...
    console.warn('[PageWise]', 'saveSession error', e)
  }
}
...
export async function getRecentSessions(limit = 10) {
  try {
    ...
    console.warn('[PageWise]', 'getRecentSessions error', e)
    return [];
  }
}
...
export async function getWeeklyStats() {
  ...
  try {
    ...
    console.warn('[PageWise]', 'getWeeklyStats error', e)
    return empty;
  }
}
...
export async function getSessionHistory() {
  try {
    ...
    console.warn('[PageWise]', 'getSessionHistory error', e)
    return [];
  }
}
