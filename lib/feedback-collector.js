  ...
  async function _loadFeedback() {
    ...
    try {
      ...
      _feedbackCache = raw[FEEDBACK_KEY] || null;
       ...
       console.warn('[PageWise]', 'feedback load error', _e)
       _feedbackCache = null;
    }
  ...
  async function _getInstallDate() {
    try {
      ...
      return raw[INSTALL_DATE_KEY] || null;
       ...
       console.warn('[PageWise]', 'install date read error', _e)
       return null;
    }
  }
  ...
  async function _isDismissed() {
    try {
      ...
      return !!raw[DISMISSED_KEY];
       ...
       console.warn('[PageWise]', 'dismissed flag read error', _e)
       return false;
    }
  }
  ...
  return {
    ...
    async submitFeedback(score, comment = '') {
      ...
      try {
        ...
        console.warn('[PageWise]', 'feedback save error', _e)
      }
    ...
    async dismissPrompt() {
      try {
        ...
        console.warn('[PageWise]', 'feedback dismiss save error', _e)
      }
    },
