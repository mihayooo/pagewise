...
class BookmarkSharing {
  ...
  static _encodeBase64(str) {
    ...
    return globalThis.Buffer.from(str, 'utf-8').toString('base64'); // eslint-disable-line no-undef
  }
  ...
  static _decodeBase64(base64) {
    ...
    return globalThis.Buffer.from(base64, 'base64').toString('utf-8'); // eslint-disable-line no-undef
  }
}
